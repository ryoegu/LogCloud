...
// KIProgressView
#define COCOAPODS_POD_AVAILABLE_KIProgressView
#define COCOAPODS_VERSION_MAJOR_KIProgressView 0
#define COCOAPODS_VERSION_MINOR_KIProgressView 1
#define COCOAPODS_VERSION_PATCH_KIProgressView 1
